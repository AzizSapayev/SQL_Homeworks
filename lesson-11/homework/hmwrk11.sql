...
Select OrderID,OrderDate, FirstName+' '+LastName as FullName
from Orders
...
Select Name, MAX(Salary), Departments.DepartmentName from Employees
Inner Join Departments On Employees.EmployeeID=Departments.DepartmentID
Group by Name,DepartmentName

Select FirstName+' '+LastName as FullName,Country,OrderID,OrderDate
from Customers
Inner Join Orders On Customers.CustomerID=Orders.CustomerID
where Orders.OrderDate between '2023.01.01' and '2023.12.31'and Customers.Country='USA'
...
Select ProductName,Suppliers.SupplierName
from Products
Inner Join Suppliers On Products.SupplierID=Suppliers.SupplierID
where SupplierName='Gadget Supplies'
or SupplierName='Clothing Mart'

Select FirstName+' '+LastName as FullName,Orders.OrderID,Orders.OrderDate
from Customers
Left Join Orders On Customers.CustomerID=Orders.CustomerID
and OrderDate=(
...
Select FirstName+' '+LastName as FullName,TotalAmount
from Customers
Inner Join Orders On Customers.CustomerID=Orders.CustomerID
...
Select Name, Salary, Departments.DepartmentName from Employees
Inner Join Departments On Employees.EmployeeID=Departments.DepartmentID
where Salary>60000 and DepartmentName='Marketing'

Select ProductName,StockQuantity, SaleDate
from Products
Inner Join Sales On Products.ProductID=Sales.ProductID
where SaleDate between '2023.01.01' and '2023.12.31'
or StockQuantity> 100

Select Name,Departments.DepartmentName,HireDate
from Employees
Inner Join Departments On Employees.DepartmentID=Departments.DepartmentID
where DepartmentName='Sales'
or HireDate>'2020.01.01'

Select FirstName+' '+LastName as FullName,Orders.OrderID,Address,Orders.OrderDate
from Customers
Inner Join Orders On Customers.CustomerID=Orders.CustomerID
where Country='USA' and Address like '[0-9][0-9][0-9][0-9]%'

Select CategoryName,StockQuantity
from Products
Inner Join Categories On Products.Category=Categories.CategoryID
Group by CategoryName,StockQuantity

Select FirstName+' '+LastName as FullName,City, Orders.OrderID,Orders.TotalAmount
from Customers
Inner Join Orders On Customers.CustomerID=Orders.CustomerID
...
WHERE d.DepartmentName IN ('HR', 'Finance')
   OR (
        -- ism ichidagi unli harflar sonini hisoblash
        ( LEN(LOWER(e.Name)) 
	  ...
	  Select Name, Salary, Departments.DepartmentName from Employees
Inner Join Departments On Employees.EmployeeID=Departments.DepartmentID
where Salary>60000 and DepartmentName in('HR','Finance')
