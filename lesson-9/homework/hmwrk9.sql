...
Select DepartmentName, Employees.Name
from Departments
...
Select FirstName+' '+LastName as FullName,Orders.OrderID
from Customers
Cross Join Orders

Select Name, Courses.CourseName from
Students
Cross Join Courses
...
Select Name, Departments.DepartmentName
from Employees
INNER JOIN Departments ON Employees.DepartmentID=Departments.DepartmentID

Select Name, Enrollments.EnrollmentID
from Students
Inner Join Enrollments On Students.StudentID=Enrollments.EnrollmentID
...
Select ProductName,Price, Orders.OrderID
from Products
...
Select OrderID,Products.StockQuantity
from Orders
Cross Join Products
...
Select FirstName+' '+LastName as FullName,Sales.ProductID
from Customers
...
from Products
Inner Join Suppliers On Products.SupplierID=Suppliers.SupplierID
where Suppliers.SupplierName='Tech Distributors'

Select Amount, Orders.OrderID 
from Payments
...
or Categories.CategoryName='Furniture'

Select FirstName+' '+LastName as FullName, Sales.SaleAmount
from Customers
Inner Join Sales On Customers.CustomerID=Sales.CustomerID
where Customers.Country='USA'

select FirstName+' '+LastName as FullName,Orders.TotalAmount
from Customers
