...
Select FirstName+ ' '+ LastName as FullName,Orders.OrderDate
from Customers
...
Select Name,Courses.CourseName
from Students
Inner Join Enrollments On Students.StudentID=Enrollments.StudentID
Inner Join Courses On Enrollments.CourseID=Courses.CourseID
where Courses.CourseName='Math 101'

SELECT C.FirstName, SUM(O.Quantity) AS TotalQuantity
FROM Customers C
...
Select Name, Salary, Departments.DepartmentName from Employees
Inner Join Departments On Employees.EmployeeID=Departments.DepartmentID
where DepartmentName='Sales'and  Employees.Salary>60000

Select * from Orders
Select * from Products


SELECT o.OrderID, o.CustomerID, o.ProductID, o.OrderDate, o.TotalAmount, 
...
Select SaleID, SaleAmount, Products.ProductName
from Sales
